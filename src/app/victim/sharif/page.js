            ...
            <div className="bg-white p-6 rounded-[22px] flex gap-5">
              ...
              <div>
                ...
                <p className="text-slate-700 leading-relaxed">
                  ...
                  ইন্সটিটিউট ও হাসপাতালের সহযোগী অধ্যাপক ডা. মুহাম্মদ
                  আসাদুজ্জামান বিদ্যুৎ-এর তত্ত্বাবধানে চিকিৎসাধীন। দ্রুত উন্নত
                  চিকিৎসার জন্য তাকে ভারতের চেন্নাই নিয়ে যাওয়া জরুরি।
                </p>
              </div>
            </div>
          </section>
